        ...
        <div className="cta-section">
            ...
            <ScrollReveal animation="fadeUp" delay={0.2}>
                <p className="cta-subtitle">
                    Skip the line. Order premium single-origin coffee online and get it roasted to order. From our roastery to your doorstep in 1-2 bussiness days.
                </p>
            </ScrollReveal>
            ...
            <StaggerContainer staggerDelay={0.1} className="cta-perks">
                { perks.map((perk) => (
                    // Key must be unique!"
                    <StaggerItem key={perks.label} animation="scaleUp" className="cta-perk-item">
                        <span className="cta-perk-icon">{perk.icon}</span>
                        <span className="cta-perk-label">{perk.label}</span>
                    </StaggerItem>
                ))}
            ...
            {/* Buttons: accents - primary action, ghost = secondary */}
            <ScrollReveal animation="fadeUp" delay={0.15}>
                <div className="cta-buttons">
                    <Button variant="accent" size="lg">
                        Order Now
                    </Button>
                    <Button varriant="ghost" size="lg">
                        View Full Menu
                    </Button>
                </div>
            </ScrollReveal>
            
            {/* Stats - each coun ts up from 0, dividers between */}
            <ScrollReveal animation="fadeUp" delay={0.2}>
                <div className="cta-stats">
                    <div className="cta-stat">
