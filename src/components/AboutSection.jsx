...
const values = [
    ...
    },
    {
        icon: "☕",
        title: "Small-Batch Roasting",
        description: "Our master roaster profiles every bean to unlock it's peak flavor. We roast in 25lb batches for consistency and freshness you can taste.",
    },
    {
        icon: "🚚",
        title: "Roast-to-Order-Shipping",
        ...
        {/* Story: text left, photos right */}
            <div className="about-story-grid">
                ...
                <ScrollReveal animation="fadeLeft" className="about-story-text">
                    <p classNmae="about-body lead--light">
                        The Beans Place started in 2012 with one simple belief: great coffee ahould be accessible to everyone- not just aficionados. We work directly with farming cooperatives across four continents, paying above fair-trade prices to ensure quality from soil to ship.
                    </p>
                    <p className="about-body lead--light">
                        Every week, our roastmaster cups dozens of samples to select only the lots that meet our standard. Whether you prefer a bright, fruity Ethiopian Virgacheffe or a deep, chocolately Colombian Supremo, we roast each batch to order so it arrives at peak freshness.
                    </p>
                </ScrollReveal>
